        ...
        {isMenuOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed top-20 left-[10%] transform -translate-x-1/2 h-[60vh] w-[80%] bg-[#393e46] z-50 shadow-xl md:hidden rounded-[18px] bg-gradient-to-b from-[#00ADB5] to-[#393E46] border-white"
            >
